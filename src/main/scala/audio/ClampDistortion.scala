...
class ClampDistortion(defaultCtrl: Int = 16, clampFrac: Int = 256) extends VolumeControl(defaultCtrl) {
  ...
  val clampUpper = (pow(2.toFloat, (DATA_WIDTH - 1).toFloat).toInt / clampFrac).S
